...
import webob.dec
import webob.exc
from nile.common import base_exception as exception
...
CONF = cfg.CONF
DEFAULT_XMLNS = "http://yongqianbao.com/nile"
XMLNS_ATOM = "http://.../Atom"
...
class ExtensionManager(object):
    ...
    EXT_NAMESPACE = 'nile.api.extensions'
...
class ResourceExtension(BaseResourceExtension):
    def __init__(self, collection, controller, parent=None,
        ...
        super(ResourceExtension, self).__init__(
            ...
            serializer=wsgi.NileResponseSerializer())
