var require = {
    ...
    paths: {
        ...
        'jquery': [
            '../styles/js/jquery.min'
        ],
        'jquery-ui': '../styles/js/jquery-ui.min',

        'bootstrap': '../styles/js/bootstrap.min',

        'angular': '../styles/js/angular.min',
        'angular-cookies': '../styles/js/angular-cookies.min',
        'angular-resource': '../styles/js/angular-resource.min',
        'angular-sanitize': '../styles/js/angular-sanitize.min',
        'angular-animate': '../styles/js/angular-animate.min',
        'ngDialog': '../styles/js/ngDialog',
        ...
        'bootstrap-switch':'../plugin/bootstrap/dist/js/bootstrap-switch',
        ...
        'jquery-md5':'../styles/js/jquery.md5',
        'jstree': '../plugin/jstree/dist/jstree.min',
        'ngJsTree': '../plugin/jstree/dist/ngJsTree',
