        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                element.on('click', 'a[data-ui-sref]', function (e) {
                    ...
                    $('div#preview-template').css('display','none');

                    $('a.lastView').find('i').removeClass('txt-color-white');
                    $('a.lastView').find('i').addClass('txt-color-greenDark');
                    $('a.lastView').removeClass('lastView');
                    if($(this).find('i').hasClass('txt-color-greenDark')){
                        $(this).find('i').removeClass('txt-color-greenDark');
                        $(this).find('i').addClass('txt-color-white');
                        $(this).addClass('lastView');
                    }
