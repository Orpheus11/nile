...
from nile.common import lockutils
from nile.common.i18n import _
from nile.common import threadgroup
...
class ServiceLauncher(Launcher):
    ...
    def __init__(self, restart_method='reload'):
        ...
        """
        super(ServiceLauncher, self).__init__( restart_method=restart_method)
...
class ProcessLauncher(object):
    ...
    def __init__(self, wait_interval=0.01, restart_method='reload'):
        """Constructor.
    ...
    def _child_process(self, service):
        ...
        launcher = Launcher(restart_method=self.restart_method)
...
def launch(service, workers=1, restart_method='reload'):
    """Launch a service with a given number of workers.
    ...
    if workers is None or workers == 1:
        launcher = ServiceLauncher(restart_method=restart_method)
    else:
        launcher = ProcessLauncher(restart_method=restart_method)
